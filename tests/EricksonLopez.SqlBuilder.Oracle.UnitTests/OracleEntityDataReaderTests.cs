...
public class OracleEntityDataReaderTests
{
    ...
    public void ReadAndAccessAllTypedFields_Succeeds()
    {
        ...
        using var reader = new OracleEntityDataReader<DummyEntity>(entities);
    ...
    public void GetValue_WithNullValueOrEmptyParameters_ReturnsDBNull()
    {
        ...
        using var reader = new OracleEntityDataReader<SpecialBindingEntity>(entities);
        reader.Read().Should().BeTrue();
    ...
    public void GetValue_WhenIsNullIsTrue_ReturnsDBNullWithoutCallingBindParameter()
    {
        ...
        using var reader = new OracleEntityDataReader<ThrowingOnNullEntity>(entities);
        reader.Read().Should().BeTrue();
        reader.GetValue(0).Should().Be(DBNull.Value);
    }
}
