...
public class CrudTests
{
    ...
    public CrudTests(MySqlFixture fixture)
    {
        _fixture = fixture;
        EricksonLopez.SqlBuilder.Dapper.DapperExtensions.RegisterCompiler<MySqlConnector.MySqlConnection>(() => new MySqlCompiler());
