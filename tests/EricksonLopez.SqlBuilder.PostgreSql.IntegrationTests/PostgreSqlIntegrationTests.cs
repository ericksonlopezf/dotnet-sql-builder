...
public class PostgreSqlIntegrationTests : IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        using var connection = new NpgsqlConnection(_pgSqlContainer.GetConnectionString());
    ...
    public async Task ExhaustiveCrud_ShouldWorkPerfectly()
    {
        ...
        user1.Id = 0; // let SERIAL handle it
        ...
        // BulkInsertAsync might return exact counts depending on Npgsql/Dapper configuration
