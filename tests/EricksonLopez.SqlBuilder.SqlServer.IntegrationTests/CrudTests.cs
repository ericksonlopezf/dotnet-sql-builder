...
public class CrudTests
{
    ...
    public CrudTests(SqlServerFixture fixture)
    {
        _fixture = fixture;
        EricksonLopez.SqlBuilder.Dapper.DapperExtensions.RegisterCompiler<Microsoft.Data.SqlClient.SqlConnection>(() => new SqlServerCompiler());
