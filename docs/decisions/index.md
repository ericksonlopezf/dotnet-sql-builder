...
> This directory contains all **47 accepted + 2 proposed + 1 rejected** Architecture Decision Records (ADRs) for EricksonLopez.SqlBuilder.
...
| ADR | Title | Status | Version |
|-----|-------|--------|---------|
| [ADR-010](./adr-010-bulk-api-architecture.md) | Bulk insert API (IBulkStrategy plugin model) | ✅ Accepted | v1.0 |
| [ADR-011](./adr-011-raw-sql-escape-hatch-policy.md) | Raw SQL escape hatch policy | ✅ Accepted | v1.0 |
| [ADR-012](./adr-012-pagination-strategy.md) | Pagination strategy (Offset + Window + Keyset + Composite Cursor) | ✅ Accepted | v1.0 |
| [ADR-020](./adr-020-recursive-cte-support.md) | Recursive CTE support | ✅ Accepted | v1.0 |
| [ADR-021](./adr-021-returning-output-clause-design.md) | RETURNING / OUTPUT clause design | ✅ Accepted | v1.0 |
| [ADR-022](./adr-022-concurrency-token-update.md) | Concurrency token in UPDATE (optimistic locking) | ✅ Accepted | v1.0 |
| [ADR-018](./adr-018-window-function-expression-support.md) | Window function typed expressions (FILTER deferred) | ✅ Accepted | v1.0 |
| [ADR-019](./adr-019-cross-apply-lateral-join-deferred.md) | CROSS APPLY / LATERAL JOIN (typed outer-ref deferred) | ✅ Accepted | v1.0 |
| [ADR-031](./adr-031-set-operations-all-modifiers.md) | Set operations ALL modifiers (INTERSECT ALL, EXCEPT ALL) | ✅ Accepted | v1.3 |
| [ADR-032](./adr-032-null-safe-equality-predicates.md) | Null-safe equality predicates (IS DISTINCT FROM) | ✅ Accepted | v1.3 |
| [ADR-033](./adr-033-projection-sentinels-nullif-coalesce.md) | Projection sentinels (NULLIF and multi-arg COALESCE) | ✅ Accepted | v1.3 |
| [ADR-034](./adr-034-analytical-grouping-sets-rollup-cube.md) | Analytical grouping sets, rollup, and cube | ✅ Accepted | v1.3 |
| [ADR-035](./adr-035-window-function-filter-clause.md) | Window function FILTER (WHERE ...) clause | ✅ Accepted | v1.3 |
| [ADR-036](./adr-036-lateral-join-outer-reference-resolution.md) | Typed LATERAL JOIN with Sql.Outer<T> reference resolution | ✅ Accepted | v1.3 |
| [ADR-037](./adr-037-cte-materialization-hints.md) | CTE Materialization hints (MATERIALIZED / NOT MATERIALIZED) | ✅ Accepted | v1.3 |
| [ADR-038](./adr-038-opentelemetry-semantic-conventions.md) | OpenTelemetry database semantic conventions per dialect | ✅ Accepted | v1.3 |
| [ADR-039](./adr-039-aot-sql-renderer-abstract-bulk-contract.md) | AotSqlRendererBase abstract bulk contract enforcement | ✅ Accepted | v1.3 |
| [ADR-040](./adr-040-esql026-deprecated-merge-analyzer.md) | Roslyn Analyzer ESQL026 for deprecated generic MERGE | ✅ Accepted | v1.3 |
...
|-----|-----------------|--------|
| [ADR-007](./adr-007-no-change-tracking.md) | Change tracking | Requires mutable state — contradicts immutable AST |
| [ADR-007](./adr-007-no-change-tracking.md) | Navigation properties (lazy loading) | Unpredictable query generation; N+1 trap; defeats predictability |
| [ADR-007](./adr-007-no-change-tracking.md) | Identity map / first-level cache | Hidden state; thread safety; non-obvious lifetime |
| [ADR-008](./adr-008-no-linq-iqueryable-provider.md) | LINQ `IQueryable<T>` provider | Impossible to guarantee AOT safety and predictable SQL translation |
| [ADR-024](./adr-024-no-automatic-query-caching.md) | Automatic query caching | Hidden state; cache invalidation; memory leak risk |
| [ADR-023](./adr-023-no-di-logging-core-dependencies.md) | Built-in DI container integration | Unnecessary coupling; forces framework on all users |
| [ADR-003](./adr-003-polly-not-core-dependency.md) | Polly as Core dependency | Optional concern; forces resilience on users who don't need it |
| [ADR-023](./adr-023-no-di-logging-core-dependencies.md) | ILogger in Core | Forces logging framework; users should choose their stack |
| [ADR-025](./adr-025-no-generic-merge-abstraction.md) | Generic cross-dialect MERGE abstraction | SQL Server MERGE has correctness/concurrency bugs; abstraction would hide them |
...
## Proposed ADRs (Pending Implementation)
