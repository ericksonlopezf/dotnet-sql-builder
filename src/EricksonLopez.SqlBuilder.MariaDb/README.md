...
[![Target Frameworks](https://img.shields.io/badge/.NET-net8.0%20%7C%20net9.0%20%7C%20net10.0-blue.svg)](https://dotnet.microsoft.com)
...
- âœ… **Native RETURNING**: Supports `RETURNING col1, col2` on INSERT, UPDATE, and DELETE (MariaDB 10.5+).

## Key Differences from MySQL Dialect

| Feature | MySQL | MariaDB |
|---------|-------|---------|
| `RETURNING` clause | âŒ Throws `NotSupportedException` | âœ… Native (10.5+) |
| Identifier quoting | `` `backtick` `` | `` `backtick` `` |
| `LIMIT/OFFSET` | âœ… | âœ… |
| `ON DUPLICATE KEY UPDATE` | âœ… | âœ… |
