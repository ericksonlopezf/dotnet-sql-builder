...
namespace EricksonLopez.SqlBuilder.Analyzers
{
    ...
    public class BatchSizeExceedsMaxAnalyzer : DiagnosticAnalyzer
    {
        ...
        private static void AnalyzeInvocation(SyntaxNodeAnalysisContext context)
        {
            ...
            if (context.SemanticModel.GetSymbolInfo(invocation).Symbol is not IMethodSymbol symbol) return;
            ...
            if (context.SemanticModel.GetConstantValue(argExpr).Value is not int batchSize) return;
